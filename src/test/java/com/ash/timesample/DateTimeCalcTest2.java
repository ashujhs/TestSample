...
public class DateTimeCalcTest2 {
    XLogger logger = XLoggerFactory.getXLogger(DateTimeCalcTest2.class);
    ...
    /**
     * Performance test data calculator and it loads 10 M records and process then in <1s
     * @throws Exception
     */
    @Test
    public void dateCalculator_performance_test() throws Exception {
        ...
        watch.reset();
        watch.start();
        DateTimeCalculator2 calc = new DateTimeCalculator2();
        String sample1 = "2017-10-08";
        String sample2 = "2017-11-09";
        String sample3 = "2017-01-08";
        String sample4 = "2017-09-01";
    ...
    public void processTestHappyPathWithDataSource() throws  Exception{
        ...
        long value = calc.processor(sample1,"data.txt",10L);
        logger.info("Data returned "+value);
        org.junit.Assert.assertEquals("Total count of all the records",132,value);
    }

    /**
     * Test to check the performance of the application
     * @throws Exception
     */
    @Test
    public void processTestHappyPath_PERF_withDataSource() throws  Exception{
        DateTimeCalculator2 calc = new DateTimeCalculator2();
        String sample1 = "2017-10-09";
        StopWatch stopWatch = new StopWatch();
        stopWatch.start();
        long value = calc.processor(sample1,"data1.txt",10000L);
        stopWatch.stop();
        logger.info("Data returned in {} and the result is - {}",stopWatch.toString(),value);
    }
